...
def meyexudi():
  ...
  try:
    ...
    if id in httpCaht:
     ...
     print("\033[92;1m┗━\033[97;1m[\033[92;1m+\033[97;1m] \033[92;1mYOUR KEY : +ak+myid+imt)
...
os.system('espeak -a 300 " Welcome,   to,  RASEL,  Tools"')
def back():
	login()
...
while attemps < 12345677901:
    ...
    if username == 'm=d' :
        print(' \033[0;92mLogin Successfully Bro.')
        break
    else:
